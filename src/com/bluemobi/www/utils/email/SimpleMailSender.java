package com.bluemobi.www.utils.email;
...
public class SimpleMailSender {
	 ...
	 * @tomail:接收的邮箱
	 */
	public static boolean sendMail(String title, String content, String type,
			String tomail) throws Exception {
		
		// 这个类主要是设置邮件
		MailSenderInfo mailInfo = new MailSenderInfo();
		
		String host = CustomPropertiesUtils.getValue("mailHost");
		String port = CustomPropertiesUtils.getValue("mailPort");
		String userName = CustomPropertiesUtils.getValue("userName");
		String password = CustomPropertiesUtils.getValue("password");
		String from = CustomPropertiesUtils.getValue("from");
	...
	public static void main(String[] args) {
		...
		mailInfo.setValidate(true);
		mailInfo.setUserName("54459622@qq.com");
		mailInfo.setPassword("54459622@qq.com");// 您的邮箱密码
		mailInfo.setFromAddress("54459622@qq.com");
		mailInfo.setToAddress("lip2@bluemobi.cn");
		...
		/*String pass = CipherUtil.generatePassword("54459622@qq.com");
