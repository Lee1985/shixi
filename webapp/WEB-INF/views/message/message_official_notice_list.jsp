...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;width: 98%;height: 98%">
		<table id="dg" class="easyui-datagrid"
			style="" url="message/messageOfficialNoticeAjaxPage.do"
			...
			<thead>
				<tr>
					...
					<th field="description" align="center" width="200">短描述</th>
		...
		<div id="toolbar">
			...
			<div style="margin-bottom:5px">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					onclick="doDelete('message/messageOfficialNoticeAjaxDelete.do')">删除</a>
				</security:act> 
				<security:act optCode="isYes">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						iconCls="icon-lock_open" plain="true"
						onclick="doUpdateStatus('message/messageOfficialNoticeUpdateStatus.do',1)">启用</a>
				</security:act>
				<security:act optCode="isNo">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						iconCls="icon-lock" plain="true"
						onclick="doUpdateStatus('message/messageOfficialNoticeUpdateStatus.do',0)">禁用</a>
				</security:act>
			</div>
		</div>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="message/messageOfficialNoticeAjaxSave.do"
				...
				<div class="fitem">
					<label>短描述:</label> <input id="description" name="description"
						style="width: 200px" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
