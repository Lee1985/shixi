...
<script type="text/javascript"
	src="js/system/easy.js"></script>
<script type="text/javascript"
	src="js/system/base.js"></script>
<style type="text/css">
#fm {
	margin: 0;
	padding: 10px 5px;
...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;width: 98%;height: 98%">
		<table id="dg" class="easyui-datagrid" style="width:98%;min-height:400px" fit="true"
			url="system/systemRoleAjaxPage.do" iconCls="icon-save"
			 rownumbers="true" pagination="true" singleSelect="true"
			toolbar="#toolbar">
			<thead>
				<tr>
					<th data-options="field:'name',width:180,align:'center',sortable:true">标题</th>
					<th data-options="field:'description',width:280,align:'center',sortable:true">备注</th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="system/systemRoleAjaxSave.do" novalidate>
				<div class="fitem">
					<label>名称:</label> 
				...
				<div class="fitem">
					<label>备注:</label> 
					<input id="description" name="description" style="width: 200px;height:60px"
