...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;width: 98%;height: 98%">
		...
		<div id="toolbar">
			<div>
				名称: <input id="typeName" class="easyui-textbox" style="width:180px">
			...
			<div style="margin-bottom:5px">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					onclick="doDelete('system/systemRoleTypeAjaxDelete.do')">删除</a>
				</security:act> 
			</div>
		</div>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="system/systemRoleTypeAjaxSave.do"
