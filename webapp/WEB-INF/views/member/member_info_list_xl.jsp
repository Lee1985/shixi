...
<script type="text/javascript">
	function searchData() {
		$('#dg').datagrid('load', {
			...
			mobile : $('#mobile').val(),
			educationStatus:$('#educationStatus').combobox('getValue')
		});
	}
	function save() {
		var index ;
...
// 		}
	...
	function formatEducationStatus(value, row) {
		if (value==1) {
			...
			return "<a href=\"javascript:void(0)\" class=\"detailcls\" onclick=\"doEditEducation('"+row.id+"','"+row.realName+"','"+row.degreepictureInfo.urlPath+"','"+row.diplomapictureInfo.urlPath+"','"+row.school+"')\">审核中</a>";
		} else {
			return "未提交";
		}
	}
	...
	function doUpdateStatus(educationStatus) {
		if(educationStatus == '2' && $('#reply').textbox('getValue') == ''){
			$.messager.show({
					title : '提示',
					msg : '请填写反馈！'
				});
...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;width: 98%;height: 98%">
		<table id="dg" class="easyui-datagrid"
			style="" url="member/memberInfoAjaxPage.do?type=3"
			...
			<thead>
				<tr>
					...
					<th field="educationStatus" align="center" width="100" formatter="formatEducationStatus">学历认证状态</th>
		...
		<div id="toolbar">
			<div>
				...
				状态:<select class="easyui-combobox" id="educationStatus" name="educationStatus"
						style="width:120px;"
		...
		<div id="dlgRealName" class="easyui-dialog"
			...
			<div class="ftitle">实名认证</div>
				...
				<div class="fitem">
					<label>身份证正面:</label> <img id="idCardA" alt=""
							src="" style="width: 150px;height: 100px">
				</div>
				<div class="fitem">
					<label>身份证反面:</label> <img id="idCardB" alt=""
							src="" style="width: 150px;height: 100px">
				</div>
		</div>
		<div id="dlgRealName-buttons">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-no" onclick="doUpdateRealName('member/memberInfoUpdateRealName.do','2')" style="width:90px">拒绝</a> 
		</div>
...
<!-- 				<div class="fitem"> -->
<!-- 					<label>学位证:</label> <a id="degreeImgboxer" title="学位证" rel="gallery" class="boxer" href=""><img id="degreeImg" alt="" -->
<!-- 							src="" style="width: 150px;height: 100px"></a> -->
<!-- 				</div> -->
				<div class="fitem">
					<label>毕业证（学生证）:</label> <a id="diplomaImgboxer" title="毕业证" rel="gallery" class="boxer" href=""><img id="diplomaImg" alt=""
							src="" style="width: 150px;height: 100px"></a>
				</div>
				<script>
						$(function(){
		...
		<div id="dlg_reply-buttons2">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-ok" onclick="doUpdateEducation('member/memberInfoUpdateEducation.do','2')"
				style="width:90px">发送</a>
			<a href="javascript:void(0)" class="easyui-linkbutton"
