...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;width: 98%;height: 98%">
		<table id="dg" class="easyui-datagrid"
			style="" url="recruit/recruitInformantTypeAjaxPage.do"
			iconCls="icon-save" rownumbers="true" pagination="true" fit="true"
			singleSelect="true" toolbar="#toolbar">
			<thead>
				<tr>
					<th field="title" align="center" width="200">举报类别</th>
		...
		<div id="toolbar">
			<div>
				举报类别: <input id="title" class="easyui-textbox" style="width:180px">
			...
			<div style="margin-bottom:5px">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					onclick="doDelete('recruit/recruitInformantTypeAjaxDelete.do')">删除</a>
				</security:act> 
				<security:act optCode="isYes">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						iconCls="icon-lock_open" plain="true"
						onclick="doUpdateStatus('recruit/recruitInformantTypeUpdateStatus.do',1)">启用</a>
				</security:act>
				<security:act optCode="isNo">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						iconCls="icon-lock" plain="true"
						onclick="doUpdateStatus('recruit/recruitInformantTypeUpdateStatus.do',0)">禁用</a>
				</security:act>
			</div>
		</div>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="recruit/recruitInformantTypeAjaxSave.do"
				data-options="novalidate:true">
				<input type="hidden" id="id" name="id">
				<div class="fitem">
					<label>举报类别:</label> <input id="title" name="title"
